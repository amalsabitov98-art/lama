...
2. При каждом push в `main` сборка публикуется на `https://amalsabitov98-art.github.io/imanpresentation/`.

Сайт обслуживается из подпапки `/imanpresentation/`, поэтому в `vite.config.ts` задан соответствующий `base`.
